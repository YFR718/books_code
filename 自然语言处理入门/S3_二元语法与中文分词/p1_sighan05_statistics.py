...
from 自然语言处理入门.tools.test_utility import ensure_data,test_data_path
...
def count_corpus(train_path: str, test_path: str):
    ...
    return train_chars / 10000, len(train_counter) / 10000, train_freq / 10000, \
           train_chars / train_freq, test_chars / 10000, len(test_counter) / 10000, \
           test_freq / 10000, test_chars / test_freq, test_oov / test_freq * 100
